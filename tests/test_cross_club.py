"""
Test Cross Club scraper
"""
from browser_scraper import CrossClubBrowserScraper

# Test for November 2025
scraper = CrossClubBrowserScraper(month=11, year=2025)
events = scraper.scrape()
validation = scraper.validate(min_events=8, max_events=20)

print(f"\n{'='*60}")
print(f"Cross Club - Test Results")
print(f"{'='*60}")
